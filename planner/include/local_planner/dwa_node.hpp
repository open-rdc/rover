...
private:
    ...
    double calculate_heading_cost(double linear, double angular, const geometry_msgs::msg::PoseStamped& robot_pose);
    double calculate_obstacle_cost(double linear, double angular, const geometry_msgs::msg::PoseStamped& robot_pose);
    double calculate_velocity_cost(double linear, double angular);
    bool check_collision(double linear, double angular, const geometry_msgs::msg::PoseStamped& robot_pose);
