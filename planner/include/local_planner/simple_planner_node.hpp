#ifndef LOCAL_PLANNER__SIMPLE_PLANNER_NODE_HPP_
#define LOCAL_PLANNER__SIMPLE_PLANNER_NODE_HPP_
...
{
public:
    SimplePlanner(const rclcpp::NodeOptions& options = rclcpp::NodeOptions{});
    SimplePlanner(const std::string& name_space, const rclcpp::NodeOptions& options);
...
#endif  // LOCAL_PLANNER__SIMPLE_PLANNER_NODE_HPP_
