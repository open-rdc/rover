...
angular_max_vel_(dtor(get_parameter("angular_max_vel").as_double())),
...
angular_acceleration_(dtor(get_parameter("angular_acceleration").as_double())),
linear_resolution_(get_parameter("linear_resolution").as_double()),
angular_resolution_(dtor(get_parameter("angular_resolution").as_double())),
